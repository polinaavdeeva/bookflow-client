...
const StatisticPage: FC = () => {
  ...
  const dataBooks: Item[] = [
    ...
    { name: "Суббота", month: "Количество книг в обмене", value: 3 },
    { name: "Воскресенье", month: "Количество книг в обмене", value: 4 },
  ];

  const dataUsers: Item[] = [
    { name: "Понедельние", month: "Количество новых пользователей", value: 1 },
    { name: "Вторник", month: "Количество новых пользователей", value: 1 },
    ...
    { name: "Воскресенье", month: "Количество новых пользователей", value: 1 },
  ];

  const dataNewBooks: Item[] = [
    { name: "Понедельник", month: "Количество новых карточек книг", value: 1 },
    ...
    { name: "Воскресенье", month: "Количество новых карточек книг", value: 1 },
  ];
